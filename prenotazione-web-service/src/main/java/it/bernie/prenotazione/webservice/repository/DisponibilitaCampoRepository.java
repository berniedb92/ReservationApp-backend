...
public interface DisponibilitaCampoRepository extends JpaRepository<DisponibilitaCampo, Integer> {
	...
	public List<DisponibilitaCampo> selByNumeroCampoDate(@Param("campo") Integer campo, @Param("giorno") Date giorno);
	
	@Query(value = "SELECT * FROM disponibilita_campo WHERE campo=:campo", nativeQuery = true)
	public List<DisponibilitaCampo> selByNumeroCampo(@Param("campo") Integer campo);
