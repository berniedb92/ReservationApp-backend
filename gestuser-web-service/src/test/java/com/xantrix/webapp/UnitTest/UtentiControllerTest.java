...
import com.gestuser.webapp.Application;
...
//	{
//		mockMvc.perform(MockMvcRequestBuilders.get("/api/utenti/cerca/userid/Bernie")
//				.accept(MediaType.APPLICATION_JSON))
...
//				.andExpect(jsonPath("$.userId").value("Bernie"))
...
//				.andDo(print());
//		
//				assertThat(passwordEncoder.matches("foxmulder5", 
//						utentiRepository.findByUserId("Bernie").getPassword()))
//				.isEqualTo(true);
//	}
//	
//	String JsonData2 = 
...
//				.andExpect(jsonPath("$[0].userId").value("Bernie"))
